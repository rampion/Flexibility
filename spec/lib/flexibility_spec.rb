...
describe Flexibility do
  ...
  describe '::create_unbound_method' do
    ...
    it 'returns the block as an UnboundMethod of the given class' do
      um = Flexibility.create_unbound_method(klass) {}
    ...
    describe 'the returned UnboundMethod' do
      it 'sets self to the bound instance when called' do
        _ = self
        run = false
        um = Flexibility.create_unbound_method(klass) { _.expect( self ).to _.be( _.instance ) ; run = true }
      ...
      it "passes through any arguments given to the when called" do
        ...
        _ = self
        run = false
        um = Flexibility.create_unbound_method(klass) { |*given| _.expect( given ).to _.eq( args ) ; run = true }
      ...
      it "passes through any block bound when it is called" do
        ...
        _ = self
        run = false
        um = Flexibility.create_unbound_method(klass) { |&given| _.expect( given ).to _.be( blk ) ; run = true }
